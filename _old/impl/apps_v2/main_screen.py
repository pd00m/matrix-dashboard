...
class MainScreen:
    def __init__(self, config, modules, default_actions):
        ...
        self.bgs = {
            "sakura": Image.open("apps_v2/res/main_screen/sakura-bg.png").convert(
                "RGB"
            ),
            "cloud": Image.open("apps_v2/res/main_screen/cloud-bg-clear.png").convert(
                "RGBA"
            ),
            "forest": Image.open("apps_v2/res/main_screen/forest-bg.png").convert(
                "RGB"
            ),
        }
