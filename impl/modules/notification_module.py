...
def on_message(_, message, noti_queue, app_white_list):
    ...
    if message["type"] == "push":
        ...
        if contents["type"] == "mirror":
            ...
            print("SMS received!")
            print(contents[0]["notifications"]["title"])
            print(int(contents[0]["notifications"]["thread_id"]))
            print(contents[0]["notifications"]["body"])
            noti_queue.put(
                Notification(
                    "SMS",
                    True,
                    contents["notifications"]["thread_id"],
